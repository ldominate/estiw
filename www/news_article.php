			...
			<div class="b-left_column">
				...
				<div class="b-content">
					<div class="b-bread_links">
						<a href="#" class="b-bread_links b-link b-link_gray">О компании</a><span>/</span>
						<a href="#" class="b-bread_links b-link b-link_gray">Все новости</a><span>/</span>
						<a class="b-bread_links b-link b-link_gray">О перечислении средств в федеральный бюджет за январь-июль 2014 г.</a>
					</div>
					...
					<div class="b-news_list">
						...
						<div class="b-left">
							...
							<div class="b-subscribe_form">
								<h2>Оформление подписки</h2>
								<span class="b-text">Подпишитесь на рассылку и получайте информацию о новых событиях банка</span>
								<form action="">
									<input class="" type="text" placeholder="Ваш e-mail">
									<button class="b-btn button b-btn-blue b-btn-subscribe_form">Подписаться</button>
								</form>
							</div>
						</div>

						<div class="b-article">
							<img class="b-article_background" src="/images/images/article_background.png" alt="">
							<div class="b-article_content">
								<div class="b-article_headline">
									<h1>О перечислении средств в федеральный бюджет за январь -июль 2014 г.</h1>
									<span class="b-date">17 июня 10:42</span>
								</div>
								<div class="b-article_text">
									<p>ФТС России сообщает, что за июль 2014 года сумма доходов федерального бюджета,  таможенными органами, составляет 533,73 млрд. рублей.</p><p>Таким образом, за семь месяцев 2014 года сумма доходов федерального бюджета,  таможенными органами, составила 3923,01 млрд. рублей. ФТС России сообщает, что за июль 2014 года сумма доходов федерального бюджета, администрируемых таможенными органами, составляет 533,73 млрд. рублей.</p><p>Таким образом, за семь месяцев 2014 года сумма доходов федерального бюджета, администрируемых таможенными органами, составила 3923,01 млрд. рублей. ФТС России сообщает, что за июль 2014 года сумма доходов федерального бюджета, администрируемых таможенными органами, составляет 533,73 млрд. рублей.</p><p>Таким образом, за семь месяцев 2014 года сумма доходов федерального бюджета, администрируемых таможенными органами, составила 3923,01 млрд. рублей.</p>
									<p>Источник: <a href="/">logistic.ru</a></p>
								</div>
							</div>
						</div>
					</div>
